...
namespace CharityApplication
{
    public partial class userEventCreation : System.Web.UI.Page
    {
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd2 = charityEvent.CreateCommand();
            charityEvent.Open();
            ...
            //     SqlCommand cmd3 = new SqlCommand("select * from [User] where userEmail='" + eventmanager + "'", charityEvent);
            ...
            //   con.Open();
            //   SqlCommand cmd = new SqlCommand("INSERT INTO [CharityEvent] ([eventManagement], [eventName], [eventStartDate], [eventEndDate], [eventDescription], [eventLocation], [eventImagePath]) VALUES (" + eventLeader + ", " + eventname + ", '" + startdate + "','" + enddate + "', '" + eventdesc + "','" + eventloc + "',)", con);
            //  cmd.ExecuteNonQuery();
            //   con.Close();
            // Response.Redirect("charityStoreOverview.aspx" );
            //  }
